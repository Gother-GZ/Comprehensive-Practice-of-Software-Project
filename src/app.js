...
app.use(
  ...
  buildCrudRouter({
    ...
    requiredOnCreate: ['username', 'password_hash'],
...
app.use(
  ...
  buildCrudRouter({
    table: 'vsp_waypoints',
    idField: 'waypoint_id',
    fields: ['name', 'latitude', 'longitude', 'type', 'description'],
    requiredOnCreate: ['name', 'latitude', 'longitude'],
    floatFields: ['latitude', 'longitude'],
    filterableFields: ['name', 'type'],
    defaultOrderBy: 'waypoint_id DESC',
  }),
);
...
app.use(
  ...
  buildCrudRouter({
    ...
    fields: ['name', 'type', 'runway', 'waypoints', 'route_geom'],
    jsonFields: ['waypoints', 'route_geom'],
    filterableFields: ['name', 'type', 'runway'],
    defaultOrderBy: 'procedure_id DESC',
  }),
);
